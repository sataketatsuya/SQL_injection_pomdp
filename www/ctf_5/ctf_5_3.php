...
if (isset($_POST["id"]) && $pdo) {
    // $uq = $pdo->query("SELECT id,loginid,auth_bit FROM users WHERE loginid = '{$_POST['id']}' AND password = '{$_POST['pw']}'")->fetchAll();
...
<body>
<div id="wrapper">
Hello guys. This is type 5.
<br>
<?php if ($uq["loginid"] == 2 AND strpos($_POST["id"], 'UNION') != false) {echo 'collect column <br>';} ?>
